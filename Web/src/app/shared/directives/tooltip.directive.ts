...
export class TooltipDirective {
    ...
    show() {
        this.create();
        this.setPosition();
        this.renderer.addClass(this.tooltip, 'clock-tooltip-show');
    }

    hide() {
        this.renderer.removeClass(this.tooltip, 'clock-tooltip-show');
        window.setTimeout(() => {
    ...
    create() {
        ...
        this.renderer.addClass(this.tooltip, 'clock-tooltip');
        this.renderer.addClass(this.tooltip, `clock-tooltip-${this.placement}`);
...
@NgModule({ declarations: [TooltipDirective], exports: [TooltipDirective], imports: [CommonModule] })
